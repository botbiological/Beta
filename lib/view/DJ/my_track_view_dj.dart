...
class MyTrackViewDj extends StatefulWidget {
  const MyTrackViewDj({super.key});

  @override
  State<MyTrackViewDj> createState() => _MyTrackViewDjState();
}

class _MyTrackViewDjState extends State<MyTrackViewDj> {
